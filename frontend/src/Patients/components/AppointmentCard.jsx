...
export default function AppointmentCard({ appointment}) {
  ...
  return (
    <div className="relative overflow-hidden w-full max-w-2xl bg-white rounded-3xl p-7 border border-slate-100 shadow-[0_4px_20px_rgba(0,0,0,0.03),0_12px_32px_rgba(0,0,0,0.04)] select-none">
      
      {/* Top-Right Light Cyan Curved Badge */}
      <div className="absolute top-0 right-0 w-44 h-28 bg-[#e6f7fa] rounded-bl-[100px] pointer-events-none flex flex-col items-end pt-5 pr-7">
        <span className="text-2xl font-bold text-slate-800 tracking-tight leading-none">
          {appointment.day}
        </span>
        <span className="text-xs text-slate-500 font-normal mt-1.5">
          {appointment.time}
        </span>
      </div>
      ...
      {/* Card Footer: Doctor Info & Actions */}
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex flex-col gap-1">
            ...
            <div className="flex items-center gap-2 text-slate-700 text-sm font-normal">
              <svg className="w-4 h-4 text-slate-700 flex-shrink-0" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" />
              </svg>
              <span>{appointment.consultationType}</span>
            </div>

            {/* Sub-info: ID & Patients Ahead */}
            <div className="flex items-center gap-3.5 text-xs font-semibold">
              ...
              <div className="flex items-center gap-1.5 text-[#f0a04b]">
                <svg className="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                </svg>
                <span>{appointment.patientsAhead} patients ahead</span>
              </div>
        ...
        <button
          type="button"
          onClick={handleGetQR}
          className="flex items-center gap-2.5 px-5 py-3 rounded-xl bg-[#00b0d8] hover:bg-[#009bbf] text-white text-sm font-semibold transition-all duration-150 shadow-[0_4px_12px_rgba(0,176,216,0.25)] active:scale-[0.98]"
        >
          <span>Get QR</span>
