    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl border border-slate-200 p-6">
        <div className="flex items-center justify-between mb-1">
          <p className="text-xs text-slate-400">Showing 4 of 142 appointments</p>
        </div>
        <div className="flex items-center justify-between mb-5">
          <div>
            <h2 className="text-lg font-semibold text-slate-900">Performance Analytics</h2>
            <p className="text-sm text-slate-500">Real-time clinical throughput and operational efficiency report.</p>
          </div>
          <div className="flex items-center gap-2">
            <button className="flex items-center gap-2 px-3 py-1.5 text-sm rounded-lg border border-slate-200 bg-slate-50">
              <Calendar className="w-4 h-4 text-slate-500" />
              Today
            </button>
            <button className="flex items-center gap-2 px-3 py-1.5 text-sm rounded-lg bg-slate-900 text-white">
              <Download className="w-4 h-4" />
              Export Report
            </button>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="bg-slate-900 rounded-xl p-5 flex items-center justify-between gap-4">
          <div className="flex gap-3">
            ...
            <div>
              <p className="text-sm font-medium text-white">AI Optimization Insight</p>
          ...
          <button
            ...
            disabled={applying}
            className="px-4 py-2 text-sm font-medium rounded-lg bg-cyan-500 text-slate-950 hover:bg-cyan-400 disabled:opacity-60 flex-shrink-0"
          >
        ...
        <div className="bg-slate-900 rounded-xl p-5 flex items-center justify-between gap-4">
          <div>
            <p className="text-sm font-medium text-white">Active Scanning</p>
            <p className="text-xs text-slate-400 mt-1">
              Point device camera at patient QR code for instant check-in verification.
            </p>
          </div>
          <button className="flex items-center gap-2 px-4 py-2 text-sm font-medium rounded-lg bg-cyan-500 text-slate-950 hover:bg-cyan-400 flex-shrink-0">
